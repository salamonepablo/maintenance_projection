...
- **Carga diferida**: la importación de `openpyxl` se hace dentro del exportador para evitar fallas al iniciar el proyecto si la dependencia aún no está instalada.
